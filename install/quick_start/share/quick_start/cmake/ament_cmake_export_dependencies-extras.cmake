...
set(_exported_dependencies "ament_cmake;rclcpp;rclcpp_action;tf2_geometry_msgs;tf2_ros;moveit_core;rviz_visual_tools;moveit_visual_tools;moveit_ros_planning_interface;interactive_markers;tf2_geometry_msgs;moveit_ros_planning;pluginlib;Eigen3;Boost;control_msgs;moveit_servo")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to quick_start_DEFINITIONS, quick_start_INCLUDE_DIRS,
# quick_start_LIBRARIES, and quick_start_LINK_FLAGS.
# Additionally collect the direct dependency names in
# quick_start_DEPENDENCIES as well as the recursive dependency names
# in quick_start_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(quick_start_DEPENDENCIES ${_exported_dependencies})
  set(quick_start_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(quick_start_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(quick_start_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(quick_start_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(quick_start_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(quick_start_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND quick_start_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
